...
Desenvolvedora de software com foco em aplicações web e mobile, atuando na construção de sistemas completos que envolvem modelagem de dados, regras de negócio, interfaces funcionais e integração com banco de dados.
...
Tenho domínio em **Java, Spring Boot, JavaScript/TypeScript, Node.js, HTML, CSS**, além de bancos relacionais como **MySQL e SQLite**, utilizando boas práticas de desenvolvimento, versionamento com **Git/GitHub** e organização em camadas (**MVC e APIs REST**).

Atualmente sigo em evolução contínua, aprofundando conhecimentos em arquitetura de software, desenvolvimento fullstack e construção de produtos escaláveis.
